...
class RandomForestAnalyzer:
    """
    ランダムフォレストの学習・混同行列・10分割交差検証を扱うクラス。
    """
    ...
    def __init__(
        ...
        **rf_kwargs: Any,
        ...
        Args:
            ...
            **rf_kwargs: RandomForestClassifier に渡す引数（例: n_estimators=100, max_depth=None）。
        """
    ...
    def build_pipeline(self, model_step_name: str = "model") -> Pipeline:
        """前処理 + RandomForestClassifier の Pipeline を構築する。"""
        self.pipeline = Pipeline([
            ...
            (
                model_step_name,
                RandomForestClassifier(random_state=self.random_state, **self.rf_kwargs),
            ),
        ])
...
def build_random_forest_pipeline(
    ...
    **rf_kwargs: Any,
    ...
    """ランダムフォレストの学習用 Pipeline を構築して返す（fit 前）。"""
